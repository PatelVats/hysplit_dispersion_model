...
def run_hysplit(sim_number):
    ...
    try:
        ...
        input_kml = r"/home/oizom/Desktop/HYSPLIT/hysplit.v5.3.4_UbuntuOS20.04.6LTS/1cont&non-cont/HYSPLIT_ps.kml"

        output_kml = f"/home/oizom/Desktop/HYSPLIT/hysplit.v5.3.4_UbuntuOS20.04.6LTS/1cont&non-cont/modified_HYSPLIT_ps_{sim_number}.kml"

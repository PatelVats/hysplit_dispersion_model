...
REM # TSV plot
%PGM%\clusplot +g1 -iDELPCT -oCLUSPLOT.HTML -l%ilab1%
TYPE CLUSPLOT.HTML >>results.HTML
...
TYPE LABELS.CFG
%PGM%\trajplot +g1 -iC0.tdump -e%dur% -z80 -k0 -l0 -v4 
TYPE TRAJPLOT.HTML >>results.HTML
RENAME TRAJPLOT.HTML TRAJPLOT_C0.HTML
DEL LABELS.CFG

ECHO 'TITLE^&','TRAJECTORIES IN CLUSTER 1 of 3 Example^&' > LABELS.CFG
TYPE LABELS.CFG
%PGM%\trajplot +g1 -iC1.tdump -e%dur% -z80 -k0 -l0 -v4
TYPE TRAJPLOT.HTML >>results.html
RENAME TRAJPLOT.HTML TRAJPLOT_C1.HTML
DEL LABELS.CFG

ECHO 'TITLE^&','TRAJECTORIES IN CLUSTER 2 of 3 Example^&' > LABELS.CFG
TYPE LABELS.CFG
%PGM%\trajplot +g1 -iC2.tdump -e%dur% -z80 -k0 -l0 -v4
TYPE TRAJPLOT.HTML >>results.html
RENAME TRAJPLOT.HTML TRAJPLOT_C2.HTML
DEL LABELS.CFG

ECHO 'TITLE^&','TRAJECTORIES IN CLUSTER 3 of 3 Example^&' > LABELS.CFG
TYPE LABELS.CFG
%PGM%\trajplot +g1 -iC3.tdump -e%dur% -z80 -k0 -l0 -v4
TYPE TRAJPLOT.HTML >>results.html
RENAME TRAJPLOT.HTML TRAJPLOT_C3.HTML
DEL LABELS.CFG
   
SET tmout=Cmean.tdump 
ECHO 'TITLE^&','CLUSTER MEAN TRAJECTORIES %ilab1%^&' > LABELS.CFG
TYPE LABELS.CFG
%PGM%\trajplot +g1 -i%tmout% -e%dur% -z80 -k%nc%:123 -l-12 -v4
TYPE TRAJPLOT.HTML >>results.html
RENAME TRAJPLOT.HTML TRAJPLOT_MEAN.HTML
DEL  LABELS.CFG
